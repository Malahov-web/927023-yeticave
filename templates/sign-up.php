<main>
    ...
    <form class="form container <?= $class_invalid; ?>" action="/sign-up.php" method="POST"
        ...
        <div class="form__item <?= $class_invalid; ?>">
            ...
            <input id="email" type="text" name="email"
                   value="<?= $value = isset($user['email']) ? $user['email'] : ""; ?>" placeholder="Введите e-mail"
                   required>
        ...
        <div class="form__item <?= $class_invalid; ?>">
            ...
            <input id="password" type="text" name="password"
                   value="<?= $value = isset($user['password']) ? $user['password'] : ""; ?>"
        ...
        <div class="form__item <?= $class_invalid; ?>">
            ...
            <input id="name" type="text" name="name" value="<?= $value = isset($user['name']) ? $user['name'] : ""; ?>"
        ...
        <div class="form__item <?= $class_invalid; ?>">
            ...
            <textarea id="contacts" name="contacts" value=""
                      placeholder="Напишите как с вами связаться"><?= $value = isset($user['contacts']) ? $user['contacts'] : ""; ?></textarea>
        ...
        <div class="form__item form__item--file form__item--last <?= $class_invalid; ?>">
            ...
            <div class="preview">
                ...
                <div class="preview__img">
                    <img src="<?= $value = isset($user['avatar_url']) ? $user['avatar_url'] : ""; ?>" width="113"
                         height="113" alt="Ваш аватар">
                </div>
            </div>
